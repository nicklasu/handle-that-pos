...
class OrderTest {
    ...
    void beforeEach() {
        Product[] testProducts = {
                new Product(0, "Suola", "Kananmunan päälle naminami", 0.5F, 100),
                new Product(1,"Sokeri","Kahviin slurps", 1F, 200)
        };
        testOrder = new Order();
    ...
    void getProductList() {
        ...
        testProducts.add(new Product(0, "Suola", "Kananmunan päälle naminami", 0.5F, 100));
        testProducts.add(new Product(1,"Sokeri","Kahviin slurps", 1F, 200));
    ...
    void addProductToOrder() {
        testOrder.addProductToOrder(new Product(6, "Sinaappi", "Makkaran päälle jes", 2F, 5));
    ...
    void removeProductFromOrder() {
        testOrder.removeProductFromOrder(new Product(0, "Suola", "Kananmunan päälle naminami", 0.5F, 100));
    ...
    void CombinationTestForOrder2(){
        ...
        testOrder.addProductToOrder(new Product(6, "Sinaappi", "Makkaran päälle jes", 2F, 5));
        testOrder.removeProductFromOrder(new Product(0, "Suola", "Kananmunan päälle naminami", 0.5F, 100));
        testOrder.removeProductFromOrder(new Product(6, "Sinaappi", "Makkaran päälle jes", 2F, 5));
