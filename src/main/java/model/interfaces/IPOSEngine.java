...
public interface IPOSEngine {
     ...
     * @return 0 if not found in database, 1 if ok, 2 if no sufficient privileges for this user
     */
    ...
    /**
     * Scans a new product adding it to the order and creates a new transaction if one does not exist
